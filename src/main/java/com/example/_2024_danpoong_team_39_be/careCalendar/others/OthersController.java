...
@RestController
@RequestMapping("/api/careCalendar/others")
...
//    }
    ...
    // 특정 날짜의 일정 추가
    @PostMapping("/{careAssignmentId}")
    public ResponseEntity<Calendar> addEvent(@PathVariable Long careAssignmentId, @RequestBody Calendar calendar, Principal principal) {
        try { String loggedInUserEmail = principal.getName(); // 로그인한 사용자의 이메일
